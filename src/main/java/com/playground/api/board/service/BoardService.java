...
public class BoardService {
	...
	public List<PostResponse> getPostList(PostRequest req) {
	  	...
	  	NoticeEntity pk = NoticeEntity.builder()
			  .bbsId(req.getBoardId())
			  .build();
	  	
		List<PostEntity> postEntity = postRepository.findByNoticeEntity(pk);
		return postEntity.stream().map(entity -> PostResponse.builder()
				.noticeNo(entity.getNttSn())
				.boardId(entity.getNoticeEntity().getBbsId())
	...
	public PostResponse addPost(PostRequest postRequest) {
		PostEntity postEntity = PostEntity.builder()
		    .noticeEntity(NoticeEntity.builder().bbsId(postRequest.getBoardId()).build())
		...
		return PostResponse.builder()
				.boardId(postEntity.getNoticeEntity().getBbsId())
